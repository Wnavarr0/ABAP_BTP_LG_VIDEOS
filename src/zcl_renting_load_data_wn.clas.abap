CLASS zcl_renting_load_data_wn DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_renting_load_data_wn IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA: lt_brands    TYPE TABLE OF zrent_brands_wn,
          lt_cars      TYPE TABLE OF zrent_cars_wn,
...
** BRANDS **
    ...
    ( marca = 'AUDI' url = 'https://acroadtrip.blob.core.windows.net/catalogo-imagenes/xl/RTV8ca58632abf44d0db6f1b476fd54eec2.jpg' )
    ...
    DELETE FROM zrent_brands_wn.
    INSERT zrent_brands_wn FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_wn INTO TABLE
    @lt_brands.
...
** CARS**
    ...
    DELETE FROM zrent_cars_wn.
    INSERT zrent_cars_wn FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_wn INTO TABLE @lt_cars.
